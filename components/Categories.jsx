  ...
  return (
    <div id='categories' className='p-2 md:p-8'>
      <h2 className='text-xl font-bold py-1 px-2'>
        <span className='text-[#9147ff] hover:underline hover:cursor-pointer'>Categories</span> we think you&apos;ll
        like
      </h2>
      {/* continer */}
      <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:2xl:grid-cols-10 gap-2 py-2'>
          <CategoriesItem
